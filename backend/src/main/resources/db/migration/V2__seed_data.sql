...
-- Admin user (password: CHANGE_ME — generate a new hash with HashMaker.java)
INSERT INTO users (name, email, password_hash, role, max_hours_per_week) VALUES
    ('Admin User', 'admin@YOUR_DOMAIN_HERE', '$2a$10$PYFp4vF5/izccFo.m5f7YuHQVMfH/iYKw8gr2HGb/nzAVhjb9C3Oy', 'ADMIN', 40);
...
-- Sample staff (password: CHANGE_ME — generate a new hash with HashMaker.java)
INSERT INTO users (name, email, password_hash, role, max_hours_per_week) VALUES
    ('Alice Johnson', 'alice@YOUR_DOMAIN_HERE', '$2a$10$PYFp4vF5/izccFo.m5f7YuHQVMfH/iYKw8gr2HGb/nzAVhjb9C3Oy', 'STAFF', 20),
    ('Bob Williams', 'bob@YOUR_DOMAIN_HERE', '$2a$10$PYFp4vF5/izccFo.m5f7YuHQVMfH/iYKw8gr2HGb/nzAVhjb9C3Oy', 'STAFF', 30);
